...
public class ${listener-name-prefix}UserOperationEventListener extends AbstractUserOperationEventListener {

    private static Log audit = LogFactory.getLog(${listener-name-prefix}UserOperationEventListener.class);
