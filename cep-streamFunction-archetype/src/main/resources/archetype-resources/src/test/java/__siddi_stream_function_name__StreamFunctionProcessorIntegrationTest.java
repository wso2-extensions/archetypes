...
public class ${siddi_stream_function_name}StreamFunctionProcessorIntegrationTest {
    private static Logger logger = Logger.getLogger(${siddi_stream_function_name}StreamFunctionProcessorIntegrationTest.class);
    protected static SiddhiManager siddhiManager;

    @Test
    public void testProcess() throws Exception {
        logger.info("${siddi_stream_function_name}StreamFunctionProcessor TestCase");
