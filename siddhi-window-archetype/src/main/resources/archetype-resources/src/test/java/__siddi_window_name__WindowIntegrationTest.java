...
public class ${siddi_window_name}WindowIntegrationTest {
    private static Logger logger = Logger.getLogger(${siddi_window_name}WindowIntegrationTest.class);
    protected static SiddhiManager siddhiManager;

    @Test
    public void testProcess() throws Exception {
        logger.info("${siddi_window_name}Window TestCase");
