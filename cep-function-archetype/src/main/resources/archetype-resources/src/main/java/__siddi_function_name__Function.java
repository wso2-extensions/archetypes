...
/**
 * Siddi Function for ${siddi_function_name}
 */
public class ${siddi_function_name}Function extends FunctionExecutor {

    // conversion equivalencies
    private static final double KILOMETERS_PER_MILE = 1.609344;

    /**
     * The initialization method for ${siddi_function_name}, this method will be called before the other methods
     *
    ...
    protected void init(ExpressionExecutor[] attributeExpressionExecutors, ExecutionPlanContext executionPlanContext) {
        ...
        if (!((attributeType == Attribute.Type.DOUBLE)
            ...
            throw new ExecutionPlanValidationException("Invalid parameter type found for the argument of ${siddi_function_name} function, " +
    ...
    protected Object execute(Object data) {
        if (data != null) {
            ...
            throw new ExecutionPlanRuntimeException("Input to the ${siddi_function_name} function cannot be null");
        }
        return null;
    }
