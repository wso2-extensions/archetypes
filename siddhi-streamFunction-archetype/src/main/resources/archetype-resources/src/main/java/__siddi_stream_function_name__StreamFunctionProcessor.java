...
/**
 * ${siddi_stream_function_name} custom streamFunctionProcessor
 */
public class ${siddi_stream_function_name}StreamFunctionProcessor extends StreamFunctionProcessor {

    private static final Logger LOGGER = Logger.getLogger(${siddi_stream_function_name}StreamFunctionProcessor.class);


    /**
     * The process method of the ${siddi_stream_function_name}StreamFunctionProcessor,
    ...
    /**
     * The init method of the ${siddi_stream_function_name}StreamFunctionProcessor,
