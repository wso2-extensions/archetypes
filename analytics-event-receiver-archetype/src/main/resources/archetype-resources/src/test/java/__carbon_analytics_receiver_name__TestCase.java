...
public class ${carbon_analytics_receiver_name}TestCase extends CEPIntegrationTest {
    private static final Log log = LogFactory.getLog(${carbon_analytics_receiver_name}TestCase.class);
    ...
    @Test(groups = {"wso2.cep"}, description = "Testing ${carbon_analytics_receiver_name} receiver ")
